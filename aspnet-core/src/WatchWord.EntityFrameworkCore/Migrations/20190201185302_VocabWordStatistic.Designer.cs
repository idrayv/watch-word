...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WatchWord.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WatchWord.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WatchWord.Entities.VocabWordStatistic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WatchWord.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WatchWord.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WatchWord.Authorization.Roles.Role", b =>
                {
                    b.HasOne("WatchWord.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("WatchWord.Authorization.Users.User", "DeleterUser")
                        .WithMany()
