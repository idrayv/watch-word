...
$webHostFolder = Join-Path $slnFolder "src/WatchWord.Web.Host"
...
(Get-Content $ngConfigPath) -replace "21022", "9901" | Set-Content $ngConfigPath
(Get-Content $ngConfigPath) -replace "4201", "9902" | Set-Content $ngConfigPath
